...
exports.run = async(client, message, args) => {
  if(!message.member.hasPermission("MANAGE_GUILD") && message.author.id !== '297130271864520705') return message.channel.send("You don't have permissions to set prefix!");
