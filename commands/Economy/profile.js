...
exports.run = async (client, message, args, color) => {
  ...
  * Define this all for fix undefined from JSON
  ...
  if(!bg[user.id]){
    bg[user.id] = {
      background: 'https://cdn.discordapp.com/attachments/496284883421757450/527770715005648911/4656e81f6dc57c5.jpg'
    };
  }
  ...
  * Use try and catch for any error will caused
  ...
  return new Canvas(600, 600)
   ...
   // .addImage(cIcon, 300,355,40,40)
    ...
    .addText(`${xp}`, 370, 530) //Line 
    .addText(`¥${balance}`, 370, 560)// Line 
    .setTextAlign('center')
    .setTextFont('bold 20px Courier New')
     .addText(`${fish}`,543,455)//Line ke 135
    .addText(`${work}`, 543,555)//Line ke 136
